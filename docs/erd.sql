-- Doc PR ERD DDL (ERDCloud import용, MySQL 8 문법)
-- 기준: Doc PR 기능명세서(53개 스펙) / API 명세서
-- 생성 전략: 모든 PK는 BIGINT AUTO_INCREMENT (기존 users 테이블과 통일)
...
CREATE TABLE doc_pr_status_histories (
    id          BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE team_collaboration_charters (
    id          BIGINT AUTO_INCREMENT PRIMARY KEY,
    team_id     BIGINT   NOT NULL,
