...
public class ResolveAiReviewIssueService implements ResolveAiReviewIssueUseCase {
    ...
    @Override
    @Transactional
    public AiReviewIssue resolve(Long userId, Long docPrId, Long issueId) {
        log.info("event=ai_review_issue_resolve_시작 userId={}, docPrId={}, issueId={}", userId, docPrId, issueId);
        ...
        try {
            ...
            issue.resolve();
            AiReviewIssue updated = saveAiReviewIssuesPort.updateStatus(issueId, AiReviewIssueStatus.RESOLVED);

            log.info("event=ai_review_issue_resolve_완료 userId={}, docPrId={}, issueId={}", userId, docPrId, issueId);
            return updated;
        } catch (RuntimeException e) {
            log.warn("event=ai_review_issue_resolve_실패 userId={}, docPrId={}, issueId={}, reason={}",
